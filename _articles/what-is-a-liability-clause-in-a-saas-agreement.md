---
layout: article
title: "What is a liability clause in a SaaS agreement?"
summary: "Few clauses have a greater impact on commercial risk than the liability clause. This article explains how liability clauses operate in SaaS agreements, the forms they commonly take and why they matter to both providers and customers under Australian law."
...
- providers seek to manage unpredictable risk; and
- customers seek sufficient protection against business-critical failures.
...
<div class="clause-example">
  <p class="clause-example-label">Illustrative drafting</p>
  <p>"The Supplier's total liability under this agreement is limited to the fees paid by the Customer in the 12 months before the claim arose."</p>
</div>
...
<div class="clause-example">
  <p class="clause-example-label">Illustrative drafting</p>
  <p>"Neither party is liable for any consequential loss, including loss of profit, revenue, data, or business opportunity."</p>
</div>
...
Standard form SaaS agreements typically carve out certain categories of liability from the monetary limitation or exclusion. Common carve-outs include liability arising from:
...
A business owner **issuing** a SaaS agreement on standard terms carries the risk that a broadly drafted exclusion or limitation clause may not operate as intended. The High Court confirmed in *Darlington Futures Ltd v Delco Australia Pty Ltd* (1986) 161 CLR 500 that exclusion clauses are construed according to their natural and ordinary meaning in context, meaning a clause drafted to exclude all liability may be read narrowly if the circumstances giving rise to the loss fall outside that meaning.

A business owner **signing** a SaaS agreement as a customer should understand that an aggregate cap linked to fees paid may leave them with limited recourse in the event of a significant platform failure, data loss, or service disruption; regardless of the actual loss suffered.

Both parties to a SaaS agreement should be aware that, where the agreement is classified as a standard form contract, it may be subject to the unfair contract terms (**UCT**) regime under the Australian Consumer Law (Schedule 2, *Competition and Consumer Act 2010* (Cth)). From 9 November 2023, proposing or relying on unfair terms in standard form contracts attracts civil penalties.
