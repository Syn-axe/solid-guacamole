---
layout: article
title: "What is a SaaS agreement?"
summary: "A SaaS agreement is one of the most important commercial documents for any software business. It governs how customers access your software, allocates legal risk and protects your intellectual property as your business grows. This article explains what a SaaS agreement is, the key terms commonly included and why these Agreements are critical to allocating commercial risk under Australian law."
...
<div style="background: rgba(201,168,76,0.08); border: 1px solid rgba(201,168,76,0.18); border-left: 3px solid #C9A84C; padding: 1.5rem 1.75rem; margin-bottom: 2.5rem;">
  ...
  <p>Software as a Service (<strong>SaaS</strong>) is a software delivery model where a provider hosts an application and gives customers ongoing access to use the software through the internet, usually under a subscription arrangement. A SaaS agreement is the contract that governs the legal relationship between the software provider and the customer, setting out how the software may be accessed and used, the rights and obligations of each party and how risks are allocated throughout the subscription.</p>
</div>
...
- **liability:** how responsibility for loss or damage is allocated, including limitations on liability, exclusion of losses and caps on exposure. For more information on liability clauses in SaaS agreements see [here](/intelligence/what-is-a-liability-clause-in-a-saas-agreement);
...
[^1]: [ss 23–27](https://www5.austlii.edu.au/au/legis/cth/consol_act/caca2010265/sch2.html) *Australian Consumer Law* (*Schedule 2 to the Competition and Consumer Act 2010* (Cth)).
[^2]: [s 24(1)](https://www5.austlii.edu.au/au/legis/cth/consol_act/caca2010265/sch2.html) *Australian Consumer Law* (*Schedule 2 to the Competition and Consumer Act 2010* (Cth)).
[^3]: [ss 23(2A), 23(2B), 24(1)(a)(ii)](https://www5.austlii.edu.au/au/legis/cth/consol_act/caca2010265/sch2.html) *Australian Consumer Law* (*Schedule 2 to the Competition and Consumer Act 2010* (Cth)).
